        ...
        <div class="hero-row">
            ...
            <?php if ($view['now'] === null && $view['up_next'] === null): ?>
                <section class="hero hero--empty">
                    ...
                    <h2 class="hero__title"><?= e($idleHeroMessage) ?></h2>
                </section>
            <?php endif; ?>
        </div>

        <main class="schedule-list">
            <h2 class="schedule-list__heading">Today&rsquo;s schedule</h2>
            <?php if ($view['today'] === []): ?>
                <p class="schedule-list__empty">No sessions in this room today.</p>
            <?php else: ?>
                <div class="schedule-list__scroll">
                    <ul>
                        <?php foreach ($view['today'] as $slot): ?>
                            <?php
